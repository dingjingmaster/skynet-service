...
import (
	...
	"skynet-service/app/common/config"
	"skynet-service/app/runtime/status"
)
...
const (
	...
	mysqlconnstring       string = "root:dingjing123@tcp(172.30.50.200:3306)"		// mysql连接字符串
